<%@ Page Language="C#" MasterPageFile="~/Site.Master"  AutoEventWireup="true" CodeBehind="ConsistencyChecksRecipeConsistency.aspx.cs" Inherits="DDRPOC.ConsistencyChecksRecipeConsistency" %>
...
<table style="width: 100%;">
    ...
    <tr>
        <td colspan="4">
            <asp:Label ID="lblrpttitle" runat="server" Text="Recipe Consistency Check:" Font-Bold="True" 
    ...
    <tr>
        <td class="auto-style1">
            &nbsp;<label ><strong>From Recipe Group:</strong></label>
            </td>
          <td align="left" colspan="5"> <asp:Label Font-Bold="true" ID="Label2" runat="server" ForeColor="Red"></asp:Label></td>
    </tr>
    <tr>
        <td  colspan="2">
            <asp:ListBox ID="lstfromrecipegroupcode" runat="server" Width="100" Height="150" SelectionMode="Multiple"></asp:ListBox>
        </td>
        <td  colspan="2">
            &nbsp;</td>
    </tr>
    <tr>
        ...
        <tr>
        <td class="auto-style1">
            &nbsp;<label ><strong>To Recipe Group:</strong></label>
            </td>
          <td align="left" colspan="3"> <asp:Label Font-Bold="true" ID="Label3" runat="server" ForeColor="Red"></asp:Label></td>
    </tr>
    <tr>
        <td  colspan="2">
            <asp:ListBox ID="lsttorecipegroupcode" runat="server" Width="100" Height="150" SelectionMode="Multiple"></asp:ListBox>
        </td>
        <td  colspan="2">
            &nbsp;</td>
    </tr>
    <tr>
        ...
        <tr>
        <td class="auto-style1">
            &nbsp;<label ><strong>Recipe Number:</strong></label>
            </td>
          <td align="left" colspan="3"> <asp:Label Font-Bold="true" ID="Label4" runat="server" ForeColor="Red"></asp:Label></td>
    </tr>
    <tr>
        <td  colspan="2">
            <asp:ListBox ID="lstrecipenumbercode" runat="server" Width="100" Height="150" SelectionMode="Multiple"></asp:ListBox>
        </td>
        <td  colspan="2">
            &nbsp;</td>
    </tr>
        ...
        <td  colspan="4">
            ...
            <ContentTemplate>
                ...
                <asp:CheckBoxList ID="chklstStates" runat="server" AutoPostBack = "true">
                    <asp:ListItem Value="1">Recipe Consistency Check</asp:ListItem>
                    <asp:ListItem Value="2">R10 Recipe Consistency Check</asp:ListItem>
                </asp:CheckBoxList>
               </ContentTemplate>
             </asp:UpdatePanel>
        </td>
