<%@ Page Language="C#" MasterPageFile="~/Site.Master"  AutoEventWireup="true" CodeBehind="APOVerification.aspx.cs" Inherits="DDRPOC.APOVerification" %>
...
<table style="width: 100%;">
    ...
    <tr>
        <td colspan=4>
            <asp:Label ID="lblrpttitle" runat="server" Text="APO Verification:" Font-Bold="True" 
    ...
    <tr>
        <td style="width:50%">
        <asp:CheckBox ID="chkmainbox" runat="server" Text="APO Extracts:" 
                 Font-Bold="True" 
        ...
        <td  colspan="4">
            ...
            <ContentTemplate>
                ...
                <asp:CheckBoxList ID="chklstStates" runat="server" AutoPostBack = "true">
                    <asp:ListItem Value="1">APO Products Data</asp:ListItem>
                    <asp:ListItem Value="2">APO Setup Matrix Data</asp:ListItem>
                    <asp:ListItem Value="3">APO Setup Transitions Data</asp:ListItem>
                </asp:CheckBoxList>
               </ContentTemplate>
             </asp:UpdatePanel>
        </td>
