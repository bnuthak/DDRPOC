<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MMVerificationWarehouseData.aspx.cs" Inherits="DDRPOC.MMVerificationWarehouseData" %>
 ...
 <asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <tr>
        <td colspan="4">
            <asp:Label ID="Label6" runat="server" Text="MM Verification Warehouse Data:" Font-Bold="True" 
   ...
   <%-- <tr>
     <td colspan=4 align="left">
      <hr width="100%" /> 
        ...
        <tr>
        <td style="width:50%">
        <asp:CheckBox ID="chkmainbox" runat="server" Text="WMS View Extracts" 
       ...
       <tr>
        ...
        <td  colspan="4">
            ...
            <ContentTemplate>
                ...
                <asp:ListItem Text="Warehouse 1 view and some Warehouse level fields on Warehouse 2" Value="1"></asp:ListItem>
                <asp:ListItem Text="Warehouse 2" Value="2"></asp:ListItem>
                <asp:ListItem Text="Control Cycles" Value="3"></asp:ListItem>
            </asp:CheckBoxList>
               </ContentTemplate>
             </asp:UpdatePanel>
        </td>
