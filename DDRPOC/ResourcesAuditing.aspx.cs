...
namespace DDRPOC
{
    public partial class ResourcesAuditing : System.Web.UI.Page
    {
        ...
        protected void btngetReport_Click(object sender, EventArgs e)
        {
            ...
            {
                DDRSessionEntity.Current.reportType = "ResourcesAuditing"; // Setting the report type for this session - used in Common.cs
