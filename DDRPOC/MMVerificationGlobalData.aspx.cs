...
namespace DDRPOC
{
    public partial class MMVerificationGlobalData : System.Web.UI.Page
    {
        ...
        protected void btngetReport_Click(object sender, EventArgs e)
        {
            ...
            {
                DDRSessionEntity.Current.reportType = "MMVerificationGlobalData"; // Setting the report type for this session - used in Common.cs
        ...
        protected void Excel_To_Export(List<DataTable> GetSelectedDataTable)
        {
            try
            {
                // var filePath = @"c:\Temp\MMVerificationGlobalDataReport.csv";
                // var filePath1 = Server.MapPath("~\\Temp\\MMVerificationGlobalData.csv");
                DeleteFolder(DDRSessionEntity.Current.username);
                CreateFolder(DDRSessionEntity.Current.username);
                var filePath = Server.MapPath(string.Format("~/{0}/{1}/{2}", "Temp", DDRSessionEntity.Current.username, "MMVerificationGlobalData.xls"));
