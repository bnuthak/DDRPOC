<%@ Page Language="C#" MasterPageFile="~/Site.Master"  AutoEventWireup="true" CodeBehind="ResourcesVerification.aspx.cs" Inherits="DDRPOC.ResourcesVerification" %>
...
<table style="width: 100%;">
    ...
    <tr>
        <td colspan=4>
            <asp:Label ID="lblrpttitle" runat="server" Text="Resource Verification:" Font-Bold="True" 
    ...
    <tr>
        <td style="width:50%">
        <asp:CheckBox ID="chkmainbox" runat="server" Text="Resource Extracts" 
                 Font-Bold="True" 
        ...
        <td  colspan="4">
            ...
            <ContentTemplate>
                ...
                <asp:CheckBoxList ID="chklstStates" runat="server" AutoPostBack = "true">
                    <asp:ListItem Value="1">Basic Data</asp:ListItem>
                    <asp:ListItem Value="2">Default Values</asp:ListItem>
                    <asp:ListItem Value="3">Capacity Overview</asp:ListItem>
                    <asp:ListItem Value="4">Capacity Header</asp:ListItem>
                    <asp:ListItem Value="5">Scheduling</asp:ListItem>
                    <asp:ListItem Value="6">Cost Centers</asp:ListItem>
                    <asp:ListItem Value="7">Short Text</asp:ListItem>
                    <asp:ListItem Value="8">Distinct Cost Centers</asp:ListItem>
                </asp:CheckBoxList>
               </ContentTemplate>
             </asp:UpdatePanel>
        </td>
