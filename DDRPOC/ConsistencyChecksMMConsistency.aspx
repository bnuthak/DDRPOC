<%@ Page Language="C#" MasterPageFile="~/Site.Master"  AutoEventWireup="true" CodeBehind="ConsistencyChecksMMConsistency.aspx.cs" Inherits="DDRPOC.ConsistencyChecksMMConsistency" %>
...
<table style="width: 100%;">
    ...
    <tr>
        <td colspan="4">
            <asp:Label ID="lblrpttitle" runat="server" Text="MM Consistency Check" Font-Bold="True" 
    ...
    <tr>
        <td >
            &nbsp;<label ><strong>From Matnr:</strong></label>
            </td>
          <td align="left" colspan="3"> <asp:Label Font-Bold="true" ID="Label2" runat="server" ForeColor="Red"></asp:Label></td>
    </tr>
    <tr>
        <td  colspan="2">
            <asp:ListBox ID="lstfrommatnrcode" runat="server" Width="300" Height="150" SelectionMode="Multiple"></asp:ListBox>
        </td>
        <td  colspan="2">
            &nbsp;</td>
    </tr>
    ...
    <tr>
        <td >
            &nbsp;<label ><strong>To Matnr:</strong></label>
            </td>
          <td align="left" colspan="3"> <asp:Label Font-Bold="true" ID="Label3" runat="server" ForeColor="Red"></asp:Label></td>
    </tr>
    <tr>
        <td  colspan="2">
            <asp:ListBox ID="lsttomatnrcode" runat="server" Width="300" Height="150" SelectionMode="Multiple"></asp:ListBox>
        </td>
        <td  colspan="2">
            &nbsp;</td>
    </tr>
        ...
        <td  colspan="4">
            ...
            <ContentTemplate>
                ...
                <asp:CheckBoxList ID="chklstStates" runat="server" AutoPostBack = "true">
                    <asp:ListItem Value="1">MM Consistency Check</asp:ListItem>
                    <asp:ListItem Value="2">Inspection Types Consistency Check</asp:ListItem>
                    <asp:ListItem Value="3">Classification Consistency Check</asp:ListItem>
                </asp:CheckBoxList>
               </ContentTemplate>
             </asp:UpdatePanel>
        </td>
