...
namespace DDRPOC
{
    public partial class APOVerification : System.Web.UI.Page
    {
        ...
        protected void btngetReport_Click(object sender, EventArgs e)
        {
            ...
            {
                DDRSessionEntity.Current.reportType = "APOVerification"; // Setting the report type for this session - used in Common.cs
        ...
        protected void Excel_To_Export(List<DataTable> GetSelectedDataTable)
        {
            try
            {
                ...
                var filePath = Server.MapPath(string.Format("~/{0}/{1}/{2}", "Temp", DDRSessionEntity.Current.username, "APOVerification.xls"));
