<%@ Page Language="C#" MasterPageFile="~/Site.Master"  AutoEventWireup="true" CodeBehind="QMVerification.aspx.cs" Inherits="DDRPOC.QMVerification" %>
...
<table style="width: 100%;">
    ...
    <tr>
        <td colspan=4>
            <asp:Label ID="lblrpttitle" runat="server" Text="QM Verification:" Font-Bold="True" 
    ...
    <tr>
        <td style="width:50%">
        <asp:CheckBox ID="chkmainbox" runat="server" Text="Verification Reports" 
                 Font-Bold="True" 
        ...
        <td  colspan="4">
            ...
            <ContentTemplate>
                ...
                <asp:CheckBoxList ID="chklstStates" runat="server" AutoPostBack = "true">
                    <asp:ListItem Value="1">Inspection Plans Data</asp:ListItem>
                    <asp:ListItem Value="2">Inspection Plans Allocation Data </asp:ListItem>
                    <asp:ListItem Value="3">Batch Search Strategy Data </asp:ListItem>
                    <asp:ListItem Value="4">QM Inspection Types </asp:ListItem>
                    <asp:ListItem Value="5">Q-INFO Records Extract - DDT - Choose SAP Instance below </asp:ListItem>
                    <asp:ListItem Value="6">Q-INFO Records Extract - SAP - Choose SAP Instance below </asp:ListItem>
                </asp:CheckBoxList>
               </ContentTemplate>
             </asp:UpdatePanel>
        </td>
