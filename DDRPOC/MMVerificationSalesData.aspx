<%@ Page Language="C#" MasterPageFile="~/Site.Master"  AutoEventWireup="true" CodeBehind="MMVerificationSalesData.aspx.cs" Inherits="DDRPOC.MMVerificationSalesData" %>
...
<table style="width: 100%;">
    ...
    <tr>
        <td colspan=4>
            <asp:Label ID="lblrpttitle" runat="server" Text="MM Verification Sales Data:" Font-Bold="True" 
    ...
    <tr>
        ...
        <tr>
        <td width="10%">
            &nbsp;<label ><strong>Sales Org:</strong></label>
            </td>
          <td align="left" colspan="3"> <asp:Label Font-Bold="true" ID="Label2" runat="server" ForeColor="Red"></asp:Label></td>
    </tr>
    <tr>
        <td  colspan="2">
            <asp:ListBox ID="lstsalesorgcode" runat="server" Width="100" Height="150" SelectionMode="Multiple"></asp:ListBox>
        </td>
        <td  colspan="2">
            &nbsp;</td>
    </tr>
    ...
    <tr>
        ...
        <tr>
        <td style="width:50%">
        <asp:CheckBox ID="chkmainbox" runat="server" Text="Sales View Extracts" 
       ...
       <tr>
        ...
        <td  colspan="4">
            ...
            <ContentTemplate>
                ...
                <asp:ListItem Text="Sales General Plant Extract (plant required)" Value="1"></asp:ListItem>
                <asp:ListItem Text="Sales Org 1 (no plant)" Value="2"></asp:ListItem>
                <asp:ListItem Text="Sales Org 2 (no plant)" Value="3"></asp:ListItem>
                <asp:ListItem Text="Taxes (no plant)" Value="4"></asp:ListItem>
                <asp:ListItem Text="Sales Text" Value="5"></asp:ListItem>
            </asp:CheckBoxList>
               </ContentTemplate>
             </asp:UpdatePanel>
        </td>
