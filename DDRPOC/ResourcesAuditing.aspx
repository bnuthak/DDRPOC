<%@ Page Language="C#" MasterPageFile="~/Site.Master"  AutoEventWireup="true" CodeBehind="ResourcesAuditing.aspx.cs" Inherits="DDRPOC.ResourcesAuditing" %>
...
<table style="width: 100%;">
    ...
    <tr>
        <td colspan=4>
            <asp:Label ID="lblrpttitle" runat="server" Text="Resource Auditing:" Font-Bold="True" 
    ...
    <tr>
        <td style="width:50%">
        <asp:CheckBox ID="chkmainbox" runat="server" Text="Resource Audits" 
                 Font-Bold="True" 
        ...
        <td  colspan="4">
            ...
            <ContentTemplate>
                ...
                <asp:CheckBoxList ID="chklstStates" runat="server" AutoPostBack = "true">
                    <asp:ListItem Value="1">Missing Cost Center (KOSTL)</asp:ListItem>
                    <asp:ListItem Value="2">Missing Other Formula on Scheduling (FORTN)</asp:ListItem>
                    <asp:ListItem Value="3">Resource Missing Record in Resource Description Table</asp:ListItem>
                    <asp:ListItem Value="4">Resource Cost Center with no Linked Activity Types</asp:ListItem>
                </asp:CheckBoxList>
               </ContentTemplate>
             </asp:UpdatePanel>
        </td>
