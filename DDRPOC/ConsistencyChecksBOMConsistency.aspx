<%@ Page Language="C#" MasterPageFile="~/Site.Master"  AutoEventWireup="true" CodeBehind="ConsistencyChecksBOMConsistency.aspx.cs" Inherits="DDRPOC.ConsistencyChecksBOMConsistency" %>
...
<table style="width: 100%;">
    ...
    <tr>
        <td colspan=4>
            <asp:Label ID="lblrpttitle" runat="server" Text="BOM Consistency Check:" Font-Bold="True" 
        ...
        <td  colspan="4">
            ...
            <ContentTemplate>
                ...
                <asp:CheckBoxList ID="chklstStates" runat="server" AutoPostBack = "true">
                    <asp:ListItem Value="1">BOM Consistency Check</asp:ListItem>
                    <asp:ListItem Value="2">BOM Header & Details</asp:ListItem>
                    <asp:ListItem Value="3">R10 Bom Consistency Check</asp:ListItem>
                </asp:CheckBoxList>
               </ContentTemplate>
             </asp:UpdatePanel>
        </td>
