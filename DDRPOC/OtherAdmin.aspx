<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="OtherAdmin.aspx.cs" Inherits="DDRPOC.OtherAdmin" %>
 ...
 <asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <tr>
        <td colspan="4">
            <asp:Label ID="Label6" runat="server" Text="Admin:" Font-Bold="True" 
    ...
    <tr>
        ...
        <tr>
        <td style="width:50%">
        <asp:CheckBox ID="chkmainbox" runat="server" Text="Database" 
       ...
       <tr>
        ...
        <td  colspan="4">
            ...
            <ContentTemplate>
                ...
                <asp:ListItem Text="Database Information" Value="1"></asp:ListItem>
            </asp:CheckBoxList>
               </ContentTemplate>
             </asp:UpdatePanel>
        </td>
