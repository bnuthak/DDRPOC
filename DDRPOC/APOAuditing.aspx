<%@ Page Language="C#" MasterPageFile="~/Site.Master"  AutoEventWireup="true" CodeBehind="APOAuditing.aspx.cs" Inherits="DDRPOC.APOAuditing" %>
...
<table style="width: 100%;">
    ...
    <tr>
        <td colspan=4>
            <asp:Label ID="lblrpttitle" runat="server" Text="APO Auditing:" Font-Bold="True" 
    ...
    <tr>
        <td style="width:50%">
        <asp:CheckBox ID="chkmainbox" runat="server" Text="APO Audits:" 
                 Font-Bold="True" 
        ...
        <td  colspan="4">
            ...
            <ContentTemplate>
                ...
                <asp:CheckBoxList ID="chklstStates" runat="server" AutoPostBack = "true">
                    <asp:ListItem Value="1">APO as compared to Material Master in DDT</asp:ListItem>
                    <asp:ListItem Value="2">APO SNP STH must be equal to or greater than PDT in Material Master in DDT</asp:ListItem>
                </asp:CheckBoxList>
               </ContentTemplate>
             </asp:UpdatePanel>
        </td>
