<%@ Page Language="C#" MasterPageFile="~/Site.Master"  AutoEventWireup="true" CodeBehind="BOMVerification.aspx.cs" Inherits="DDRPOC.BOMVerification" %>
...
<table style="width: 100%;">
    ...
    <tr>
        <td colspan=4>
            <asp:Label ID="lblrpttitle" runat="server" Text="BOM Verification:" Font-Bold="True" 
    ...
    <tr>
        <td style="width:50%">
        <asp:CheckBox ID="chkmainbox" runat="server" Text="BOM Extracts" 
                 Font-Bold="True" 
       ...
       <tr>
        ...
        <td  colspan="4">
          ...
          <asp:CheckBoxList ID="chklstStates" runat="server" AutoPostBack = "true">
                    <asp:ListItem Value="1">BOM Header</asp:ListItem>
                    <asp:ListItem Value="2">Bom Details</asp:ListItem>
                    <asp:ListItem Value="3">Bom Sub-Details</asp:ListItem>
                    <asp:ListItem Value="4">Bom Header & Details</asp:ListItem>
                </asp:CheckBoxList>
               </ContentTemplate>
             </asp:UpdatePanel>
        </td>
