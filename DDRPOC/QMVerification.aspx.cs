...
namespace DDRPOC
{
    public partial class QMVerification : System.Web.UI.Page
    {
        ...
        protected void btngetReport_Click(object sender, EventArgs e)
        {
            ...
            {
                DDRSessionEntity.Current.reportType = "QMVerification"; // Setting the report type for this session - used in Common.cs
