...
{
    public class ConsistencyChecksRecipeConsistencyReport
    {
        MMDataManager mmdatamanager = new MMDataManager();
        ReportTableHeader TableHeader = new ReportTableHeader();
     
        public System.Data.DataTable SQL_Consistency_recipe_check(string title)
        {
            try
            {
        ...
        public System.Data.DataTable SQL_Consistency_R10_recipe_check(string title)
        {
            try
            {
                string command = String.Format(@"
